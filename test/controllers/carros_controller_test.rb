...
class CarrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carro" do
    assert_difference('Carro.count') do
      post carros_url, params: { carro: { ano: @carro.ano, chassi: @carro.chassi, exercicio: @carro.exercicio, modelo: @carro.modelo, placa: @carro.placa, proprietario: @carro.proprietario, renavam: @carro.renavam } }
    end
  ...
  test "should update carro" do
    patch carro_url(@carro), params: { carro: { ano: @carro.ano, chassi: @carro.chassi, exercicio: @carro.exercicio, modelo: @carro.modelo, placa: @carro.placa, proprietario: @carro.proprietario, renavam: @carro.renavam } }
